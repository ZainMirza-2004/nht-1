...
export default function SpaPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const bookingData: Database['public']['Tables']['spa_bookings']['Insert'] = {
      ...
      const { error } = await (supabase as any).from('spa_bookings').insert(bookingData);
    ...
    <div className="min-h-screen pt-20">
      <section className="relative h-96 flex items-center justify-center overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: 'url(https://images.pexels.com/photos/3757952/pexels-photo-3757952.jpeg?auto=compress&cs=tinysrgb&w=1920)',
          }}
        >
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <p className="text-xl text-white/90 max-w-2xl mx-auto">
            Indulge in tranquility with our premium spa treatments
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Choose the perfect treatment for your relaxation needs
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            >
              Need a custom package? Contact us for a quote
            </button>
          </div>
        </div>
      </section>
      ...
      >
        <p className="text-gray-700 mb-6 leading-relaxed">
          For bespoke spa experiences tailored to your specific needs, please contact our
          concierge team:
        </p>
        <div className="space-y-4 bg-gray-50 p-6 rounded-lg">
          <p className="text-gray-900">
            <strong>Email:</strong>{' '}
            <a href="mailto:spa@nhtestates.com" className="text-blue-900 hover:underline">
              spa@nhtestates.com
            </a>
          </p>
          <p className="text-gray-900">
