...
// Mock data - same 6 properties from HomePage
const mockProperties: Property[] = [
  ...
  },
  {
    ...
    sleeps: 5,
    rating: 5,
    airbnb_url: 'https://nhtestates.bookeddirectly.com/g/roath/cardiff-centre-2br-sleeps-5-jacuzzi-%2526-free-parking/923ad4?number_of_guests=1',
  },
  {
    id: '3',
  ...
  },
  {
    ...
    sleeps: 2,
    rating: 5,
    airbnb_url: 'https://nhtestates.bookeddirectly.com/g/roath/new-cinema-experience-in-cardiff-for-couples-%252B-spa/50215a?number_of_guests=1',
  },
  {
    id: '6',
  ...
  },
  {
    ...
    description: 'Stay in the heart of Wembley, just moments from the iconic Wembley Stadium. This spacious 2-bedroom accommodation sleeps up to 6 guests and features modern amenities, comfortable furnishings, and convenient on-site parking. Perfect for sports fans, concert-goers, or anyone looking to explore London. Enjoy easy access to public transport and local attractions.',
    image_url: '/Property7.jpg',
    location: 'London',
    price_per_night: 200,
    bedrooms: 2,
    sleeps: 6,
    rating: 5,
    airbnb_url: 'https://nhtestates.bookeddirectly.com/g/greater-london/central-wembley-stadium-stay-%25E2%2580%25A2-sleeps-6-%25E2%2580%25A2-parking/ffb684?number_of_guests=1',
  },
  {
    id: '8',
    title: 'Highrise Stay by Wembley Stadium',
    description: 'Experience luxury living in this stunning highrise apartment with breathtaking views, located just steps from Wembley Stadium. This modern 3-bedroom property features premium amenities including on-site parking and access to a pool. Perfect for families or groups looking for a comfortable and convenient base to explore London. Enjoy the vibrant atmosphere of Wembley with world-class entertainment right on your doorstep.',
    image_url: '/Property8.jpg',
    location: 'London',
    price_per_night: 280,
    bedrooms: 3,
    sleeps: 8,
    rating: 5,
    airbnb_url: 'https://nhtestates.bookeddirectly.com/g/greater-london/highrise-stay-by-wembley-stadium---parking---pool/428db3?number_of_guests=1',
  },
  {
    id: '9',
    title: 'The Walk Cardiff Centre Sleep 4 + FREE Parking',
    description: 'Discover this brand new 2-bedroom flat in the heart of Cardiff city centre. Perfect for up to 4 guests, this modern accommodation features contemporary design, comfortable furnishings, and the convenience of free parking. Located just minutes from Cardiff\'s best shopping, dining, and entertainment, this is the ideal base for exploring the Welsh capital.',
    image_url: '/Property9.jpg',
    location: 'Cardiff City Centre, Cardiff',
    price_per_night: 190,
    bedrooms: 2,
    sleeps: 4,
    rating: 4.5,
    airbnb_url: 'https://nhtestates.bookeddirectly.com/g/roath/new-2br-flat-cardiff-centre-sleep-4-%252B-free-parking/12eedc?number_of_guests=1',
  },
  {
    id: '10',
    title: 'Central 1BR Cardiff Flat & Free Parking + Paid Spa',
    description: 'Stay in this central 1-bedroom flat located at 16 The Walk in Roath, Cardiff. This modern accommodation features a comfortable double bed, contemporary kitchen/living space, and free parking. Enhance your stay with access to our paid spa facilities. Perfect for couples or solo travellers looking for a convenient and comfortable base in Cardiff.',
    image_url: '/Property10.jpg',
    location: 'Roath, Cardiff',
    price_per_night: 140,
    bedrooms: 1,
    sleeps: 2,
    rating: 5,
    airbnb_url: 'https://nhtestates.bookeddirectly.com/g/roath/central-1br-cardiff-flat-%2526-free-parking-%252B-paid-spa/6d92e0?number_of_guests=1',
  },
  {
    id: '11',
    title: '2 mins to city centre | Cinema + Private Spa + Parking',
    description: 'Experience the ultimate luxury stay just 2 minutes from Cardiff city centre. This stunning 2-bedroom property features a private cinema room for movie nights, access to a private spa for relaxation, and convenient on-site parking. Perfect for couples, families, or groups looking for a premium accommodation experience with exceptional amenities.',
    image_url: '/Property11.jpg',
    location: 'Roath, Cardiff',
    price_per_night: 220,
    bedrooms: 2,
    sleeps: 6,
    rating: 5,
    airbnb_url: 'https://nhtestates.bookeddirectly.com/g/roath/2-mins-to-city-centre%257C-cinema%252Bprivate-spa-%252Bparking/8778ab?number_of_guests=1',
  },
  {
    id: '12',
    title: 'Breathtaking London Skyline River Penthouse',
    description: 'Luxury penthouse with panoramic London skyline and River Thames views. Spacious open-plan living area, modern kitchen, Smart TVs, and ideal for families or groups seeking premium comfort.',
    image_url: '/Property12.jpg',
    location: 'London',
    price_per_night: 270,
    bedrooms: 4,
    sleeps: 10,
  ...
  },
  {
    ...
    description: 'Stylish three-bedroom home close to Wembley Stadium, perfect for groups and families. Features multiple beds, balcony, Smart TVs in rooms, and excellent transport access.',
    image_url: '/Property13.jpg',
    location: 'London',
    price_per_night: 280,
    bedrooms: 3,
    sleeps: 8,
  ...
  },
  {
    ...
    description: 'Comfortable two-bedroom apartment near Wembley Stadium with bright living areas and convenient transport links. Ideal for short city stays and events.',
    image_url: '/Property14.jpg',
    location: 'London',
    price_per_night: 280,
    bedrooms: 2,
    sleeps: 4,
  ...
  },
  {
    ...
    description: 'Modern one-bedroom apartment in East London (E16 1YT) with convenient access to transport links and city attractions.',
    image_url: '/Property15.jpg',
    location: 'London',
    price_per_night: 270,
    bedrooms: 1,
    sleeps: 6,
  ...
  },
  {
    ...
    description: 'Cozy one-bedroom London apartment (SE8 5EJ) with free parking, Smart TV, and fully equipped kitchen.',
    image_url: '/Property16.jpg',
    location: 'London',
    price_per_night: 270,
    bedrooms: 1,
    sleeps: 4,
  ...
  },
  {
    ...
    description: 'Comfortable one-bedroom flat featuring a private balcony, free parking, and good transport connections, ideal for short and long stays.',
    image_url: '/Property17.jpg',
    location: 'London',
    price_per_night: 260,
    bedrooms: 1,
    sleeps: 3,
  ...
  },
  {
    ...
    description: 'Spacious duplex penthouse with river views, private balcony, modern furnishings, and open-plan living, perfect for families and group stays.',
    image_url: '/Property18.jpg',
    location: 'London',
    price_per_night: 290,
    bedrooms: 3,
    sleeps: 8,
  ...
  },
  {
    ...
    description: 'Large three-bedroom Victorian house near Canary Wharf with garden, full kitchen, Smart TVs, and great access to transport and shops.',
    image_url: '/Property19.jpg',
    location: 'London',
    price_per_night: 400,
    bedrooms: 3,
    sleeps: 10,
  ...
  },
  {
    ...
    description: 'Renovated riverside apartment with balcony, modern interior, fast Wi-Fi, and comfortable sleeping for families or groups.',
    image_url: '/Property20.jpg',
    location: 'London',
    price_per_night: 200,
    bedrooms: 2,
    sleeps: 5,
...
export default function ExploreAllProperties() {
  ...
  const locations = useMemo(() => {
    const uniqueLocations = new Set(mockProperties.map((p) => p.location));
  ...
  const filteredAndSortedProperties = useMemo(() => {
    ...
    if (filters.minPrice) {
      ...
      result = result.filter((p) => p.price_per_night >= minPrice);
    }
    if (filters.maxPrice) {
      const maxPrice = parseFloat(filters.maxPrice);
      result = result.filter((p) => p.price_per_night <= maxPrice);
    }
  ...
  const groupedProperties = useMemo(() => {
    ...
    filteredAndSortedProperties.forEach((property) => {
      // Extract city name (before comma or use full location)
